...
export default function MansoryImage() {
    return (
        <>
                        ...
                        return (
                            <div className='relative flex flex-col gap-[22px]'>
                                ...
                                <div className='absolute text-bg_light_green top-[30%] right-0 flex flex-col items-start justify-center bg-dark_charcoal/35 p-[14px] rounded-tl-md rounded-bl-md h-[42px] md:h-[93px]'>
                                    <span className='text-left text-[6px] md:text-[12px] '>{item.badge}</span>
                                    <span className='font-lato font-bold text-[9px] md:text-[14px]' >{item.title}</span>
                                    <span className='font-lato font-bold  text-[9px] md:text-[14px]'>{item.brand}</span>
                                </div>
            ...
            <div className='flex flex-col md:flex-row gap-4 items-center justify-center mt-[22px]'>
                {
                    mansoryGalleryTwo.map((item, index) => {
                        return (
                            <div className='relative flex flex-col gap-[27px]'>
                                ...
                                <div className='absolute text-bg_light_green right-0 top-[50%] flex flex-col items-start justify-center  bg-dark_charcoal/35 p-[17px]  rounded-tl-md rounded-bl-md  h-[42px] md:h-[93px]'>
                                    <span className='text-left text-[6px] md:text-[12px] '>{item.badge}</span>
                                    <span className='font-lato font-bold text-[9px] md:text-[14px]'>{item.title}</span>
                                    <span className='font-lato font-bold text-[9px] md:text-[14px]'>{item.brand}</span>
                                </div>
