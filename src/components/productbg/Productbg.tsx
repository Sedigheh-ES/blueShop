...
export default function Productbg() {
    return (
        <div style={{ backgroundImage: `url('/assets/images/Products.png')` }} className='relative bg-cover md:bg-contain lg:bg-contain bg-no-repeat bg-center h-[233px] lg:h-[345px] rounded-lg'>
